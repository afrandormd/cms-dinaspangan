...
const Peraturan = ({
  ...
  const save = async () => {
    ...
    if (id != "") {
      ...
      const updateing = await updateDokumen({
        ...
        download: isDownloadable == "BISA" ? true : false,
  ...
  const handlePageChange = (page: any) => {
    if (page >= 1 && page <= totalPages) {
      router.push(`/get-panel/dokumen?page=${page}`);
    }
  };
            ...
            <div className="border p-4 flex flex-row gap-4 w-full">
              <div className="w-full">
                ...
                <Select
                  ...
                  onChange={(_value, option) => setIsDownloadable(_value!)}
                />
                <Select
          ...
          <Table className="border rounded-md">
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Bisa Download</TableHead>
                ...
                <TableRow key={item.id}>
                  ...
                  <TableCell>
                    <ActionIcon
                      variant="transparent"
                      aria-label="show"
                      onClick={() => showFile(item.fileDokumen)}
                    >
                      <IconFile
                  ...
                  <TableCell>
                    {item.isDownloadable ? "BISA" : "TIDAK-BISA"}
                  </TableCell>
                  <TableCell>
